# Build Facilities Assistant

1. In Copilot Studio, create a new agent named **Facilities Assistant**.
...
6. Test these deterministic questions:
   - Show all critical issues in Metro City.
...
- Critical Metro City: `City = 'Metro City' AND Severity = 'Critical' AND Status NOT IN ('Resolved','Rejected')`.
