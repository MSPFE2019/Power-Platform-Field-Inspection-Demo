...
Fallback narrative visual text if Copilot is unavailable: "This month, maintenance demand is concentrated in recurring road sign and water issues. Critical open work is concentrated in Portland/Multnomah, while resolved issues show average completion within the one-week SLA for most medium and low severity requests."
